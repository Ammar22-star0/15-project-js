...
form.addEventListener("submit", function (e) {
  e.preventDefault(); //send information to default server
  //console.log("hello");//ex
  const value = parseInt(amount.value); //number
  const random = Math.floor(Math.random() * text.length);
  //empty value(NAN)
  //-1
  //>9 because i have a 10 value in my array
